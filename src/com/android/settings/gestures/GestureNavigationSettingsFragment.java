...
public class GestureNavigationSettingsFragment extends DashboardFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        gestureHintPref.setOnPreferenceChangeListener((preference, newValue) -> {
            if (PixelageUtils.isPackageInstalled(getContext(), NEXUSLAUNCHER_PACKAGE_NAME)) {
                PixelageUtils.toggleOverlay(getContext(), NOGESTUREHINT_OVERLAY, (Boolean) newValue);
                PixelageUtils.restartApp(NEXUSLAUNCHER_PACKAGE_NAME, getContext());
            }
